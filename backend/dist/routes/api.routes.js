...
apiRouter.get('/admin/promotions', auth_middleware_1.authenticateToken, (0, auth_middleware_1.requireRole)([user_model_1.UserRole.ADMIN]), (0, auth_middleware_1.requireAdminPermission)(user_model_1.AdminPermission.FINANCE_READ), admin_controller_1.listAdminPromotions);
apiRouter.post('/admin/promotions', auth_middleware_1.authenticateToken, (0, auth_middleware_1.requireRole)([user_model_1.UserRole.ADMIN]), (0, auth_middleware_1.requireAdminPermission)(user_model_1.AdminPermission.FINANCE_READ), admin_controller_1.createAdminPromotion);
apiRouter.patch('/admin/promotions/:id', auth_middleware_1.authenticateToken, (0, auth_middleware_1.requireRole)([user_model_1.UserRole.ADMIN]), (0, auth_middleware_1.requireAdminPermission)(user_model_1.AdminPermission.FINANCE_READ), admin_controller_1.updateAdminPromotion);
