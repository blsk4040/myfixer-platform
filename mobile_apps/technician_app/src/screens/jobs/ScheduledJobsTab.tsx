...
const styles = StyleSheet.create({
  ...
  jobCard: { backgroundColor: '#17171A', borderRadius: 14, padding: 16, borderWidth: 1, borderColor: '#303036', marginBottom: 12 },
  timeRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 },
  timeText: { color: '#B8FF3D', fontSize: 12, fontWeight: '800' },
  priceText: { color: '#F7F7F5', fontSize: 14, fontWeight: '800' },
  applianceText: { color: '#F7F7F5', fontSize: 15, fontWeight: '700' },
  areaText: { color: '#A7A7AD', fontSize: 13, marginTop: 4 },
});
